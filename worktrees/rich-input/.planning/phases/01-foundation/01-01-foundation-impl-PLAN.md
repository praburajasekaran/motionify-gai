...
must_haves:
  - proposal_comments table exists with correct schema
  - GET /api/comments endpoint returns comments for proposal
  - POST /api/comments endpoint creates comments
  - CommentThread component renders in admin portal
  - CommentThread component renders in client portal
  - Comments persist across sessions (verified by DB check)
---
