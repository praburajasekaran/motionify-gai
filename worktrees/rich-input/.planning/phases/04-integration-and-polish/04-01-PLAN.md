...
**For BOTH admin portal (`components/proposals/`) and client portal (`deleted app source`):**
...
- Change scroll preservation logic (already implemented correctly)
  ...
  <verify>
    ...
    cd deleted app && npm run build (client portal)
  </verify>
  <done>
...
**If ANY issues found:** Fix them to match the working pattern from the other portal.
  ...
  <verify>
    grep -n "scrollPosRef" components/proposals/CommentThread.tsx deleted app source
    grep -n "handleScroll" components/proposals/CommentThread.tsx deleted app source
  </verify>
  <done>
...
**If ANY issues found:** Fix them to match the working pattern from the other portal.
  ...
  <verify>
    ...
    grep -n "onEdit" deleted app source deleted app source
  </verify>
  <done>
