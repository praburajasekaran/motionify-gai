        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              maxLength={5000}
              className="w-full px-4 py-2.5 border border-border rounded-lg bg-card text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-transparent transition-all resize-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border border-border rounded-lg bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-transparent transition-all appearance-none cursor-pointer"
              style={selectStyle}
            >
