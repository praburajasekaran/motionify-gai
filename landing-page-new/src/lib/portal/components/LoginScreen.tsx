      ...
      <div className="max-w-md w-full relative">
        ...
        <Card>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
            <p className="text-sm font-medium text-white/70 mb-3">ℹ️  What to do next:</p>
          ...
          <div className="text-center text-sm text-white/50 border-t border-white/10 pt-4">
            ...
            <a href="mailto:hello@motionify.studio" className="text-cyan-400 hover:text-cyan-300">
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative">
        ...
        <Card>
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-white">Welcome to Motionify PM Portal</h2>
            <p className="text-white/60 mt-2">Log in with your email - no password needed</p>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 text-base bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 rounded-lg text-white placeholder-white/40"
                  disabled={isLoading}
                  required
                />
              </div>
