    ...
    >
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="inline-flex items-center gap-2 mt-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 text-sm font-medium transition-colors"
        >
      ...
      {process.env.NODE_ENV === 'development' && typeof rawError !== 'string' && rawError?.stack && (
