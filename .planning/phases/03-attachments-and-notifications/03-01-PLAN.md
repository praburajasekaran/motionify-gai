...
<task type="auto">
  <name>Update deleted app CommentInput and CommentItem</name>
  <files>deleted app source, deleted app source
  <action>
    Apply same changes as tasks 4 and 5 to the deleted app versions:
    - `deleted app source` - add file upload UI
    - `deleted app source` - add attachment display
