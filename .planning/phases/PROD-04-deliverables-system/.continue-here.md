...
## DEL-02: Approval Workflow (In Progress)
- [x] Client can see deliverables
- [x] Navigation to detail page works
- [ ] Test "Approve Deliverable" button
- [ ] Test "Request Revision" button with feedback form
- [ ] Verify email notification sent on approval/rejection
- [ ] Verify status change persists to database

## DEL-03: R2 File Storage (Not Started)
- [ ] Upload file and verify stored in R2
- [ ] Download file and verify retrieval works
- [ ] Test file expiry (365 days after final_delivered)
- [ ] Test admin access to expired files

## DEL-04: Permissions (Not Started)
- [ ] Test client cannot view other client's deliverables
- [ ] Test team member access via task assignment
- [ ] Test admin/PM can view all deliverables
