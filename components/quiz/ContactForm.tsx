        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              rows={4}
              className={`w-full pl-10 pr-4 py-2.5 rounded-lg bg-white/5 border text-white placeholder-white/30 focus:outline-none focus:ring-2 transition resize-none disabled:opacity-50 disabled:cursor-not-allowed ${touched.projectNotes && errors.projectNotes
