...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 bg-gray-950 transition-all duration-300 ${
        ...
        <div className={`flex items-center justify-between transition-all duration-300 ${
          ...
          <Link href="/" className="inline-flex items-center gap-3 group">
            <Image
              ...
              width={120}
              height={36}
              className={`w-auto transition-all duration-300 group-hover:opacity-90 ${
          ...
          <div className="hidden sm:flex items-center gap-8">
            ...
            <a href="#" className={`inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 ${
