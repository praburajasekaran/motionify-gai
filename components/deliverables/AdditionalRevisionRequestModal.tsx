...
export const AdditionalRevisionRequestModal: React.FC<AdditionalRevisionRequestModalProps> = ({
        ...
        return (
            ...
            >
                <div className="p-6 text-center space-y-4">
                    ...
                    <h3 className="text-xl font-bold text-zinc-900">Request Submitted</h3>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 space-y-2">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-semibold text-zinc-900">{requestedCount}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-zinc-600">Project:</span>
                            <span className="font-semibold text-zinc-900">{projectName}</span>
                        </div>
                    </div>
    ...
    return (
        ...
        >
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <span className="text-sm text-zinc-600">Current Revision Quota</span>
            ...
            {/* Footer */}
            <div className="border-t border-zinc-200 px-6 py-4 bg-zinc-50 flex items-center justify-end gap-3">
